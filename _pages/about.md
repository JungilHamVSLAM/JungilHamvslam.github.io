...
I'm a Ph.D. candidate in the [Machine Perception and Intelligence Lab (MPIL)](https://mpil-gist.github.io/) at [GIST](https://www.gist.ac.kr/), advised by Pyojin Kim. I build structure-aware visual localization: [SF-SLAM](https://sf-slam.github.io/) (IEEE T-RO, under review), [San Francisco World](https://sanfranciscoworld.github.io/) (RA-L 2025), [DTOR](https://dtor-visualcompass.github.io/), an ISS digital-twin compass, and a [microgravity SLAM benchmark](https://openreview.net/forum?id=OujDdCpd70) on NASA's Astrobee (ICRA 2026 workshop). I'm currently working on digital-twin-anchored SLAM recovery for Astrobee, and on dynamic Gaussian Splatting SLAM that separates the static world from crowds moving with the camera.
